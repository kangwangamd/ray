...
class SGLangEngine(LLMEngine):
    ...
    async def _start_engine(self) -> "EngineBase":
        ...
        runtime_env = (
            node_initialization.runtime_env
        ...
        self._tokenizer = AutoTokenizer.from_pretrained(
            self.llm_config.engine_kwargs["model_path"]
        )
        return engine_actor
    ...
    def _get_prompt_limit(self) -> int:
        ...
        Port from
        https://github.com/vllm-project/vllm/blob/7b5ecf79bd94aab0d782c70126d0dcc37c16bc60/vllm/core/scheduler.py#L939
        """
    ...
    def _collect_usage_metrics(sampling_params: SGLangSamplingParams) -> None:
        ...
        if sampling_params.max_tokens is not None:
            usage_counters[
                ArgUsage.MAX_TOKENS
            ].inc()  # ToDo: MAX_TOKENS -> MAX__NEW_TOKENS

        if sampling_params.logprobs is not None:
            usage_counters[ArgUsage.LOGPROBS].inc()

    def _parse_sampling_params(self, sampling_params: SGLangSamplingParams) -> dict:
